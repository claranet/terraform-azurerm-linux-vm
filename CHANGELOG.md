...
* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 6926a10

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu ccb4142
* **deps:** update dependency terraform-docs to v0.23.0 f166e30
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 2a66a1d
* **deps:** update tools efdfaac
* **pre-commit:** 🔧 move to prek e383360
* **tfdocs:** bump tfdocs to v0.22 🔧 426faf6

## 8.7.2 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ bfcd11c

### Code Refactoring

* update module structure and Github actions 👷 63e2fcf

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing b118616
* **deps:** 🔗 bump tflint rules version 6b3a3f5
* **deps:** update dependency trivy to v0.69.2 17e9a44
* **deps:** update dependency trivy to v0.69.3 c71893b
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 ff5ea03

## 8.7.1 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 4a6b065

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.11.3 7185e6c
* **deps:** update dependency opentofu to v1.11.4 5d17928
* **deps:** update dependency opentofu to v1.11.5 718e640
* **deps:** update dependency tflint to v0.61.0 61f70aa
* **deps:** update dependency trivy to v0.69.0 69958c5
* **deps:** update dependency trivy to v0.69.1 e845e3c
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 953485c
